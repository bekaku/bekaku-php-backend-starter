...
use application\serviceInterface\StudentImageServiceInterface;
use application\model\StudentImage;
class StudentImageService extends BaseDatabaseSupport implements StudentImageServiceInterface
{
    protected $tableName = 'student_image';
    ...
    public function findAll($perpage=0, $q_parameter=array())
    {
        ...
        $query .="FROM student_image AS student_image ";

		//default where query
        $query .=" WHERE student_image.`id` IS NOT NULL ";
		//custom where query
       //$query .= "WHERE student_image.custom_field =:customParam ";

        //gen additional query and sort order
       $additionalParam = $this->genAdditionalParamAndWhereForListPageV2($q_parameter, new StudentImage());
    ...
    public function findById($id)
    {
        ...
        $query .="FROM student_image AS student_image ";
        $query .="WHERE student_image.`id`=:id ";
