...
class EdrYoutubeMapper extends BaseModel
{
    public static $tableName = 'edr_youtube_mapper';
    ...
    { 
       //not use audit info 
        ...
        $this->setTableField(array(
            ...
            'active' => self::TYPE_INTEGER,
            'youtube_link' => self::TYPE_STRING,
            'metadata' => self::TYPE_STRING,
        )); 
